...
def facebookPost(info):
	...
	fcfg={
		...
		"access_token":"EAAYNHre91MMBADn6ya1YP6hr014nkpMePsnPFODnH1rYEZBDCWB3dfEMNmZCwZAQ8W6cV5z2KSBTZBzmEXeyCAhmAt2qzZBuReUP9oj13ogxzvibAZAOXKdCZAhI0ZC3QTG0iySrQRQYFes252TKIZADBJDtd2AN0br0WgPbhAHa1MJc9dVSZAcrHpQszNgU2ZBiAyXQ8woKz9OjgZDZD",
	}
	g = facebook_api(fcfg)
	if g != None:
		message = "Crisis type: {}\nStreet: {}\nDescription: {}\nAdvice: {}\n".format(
